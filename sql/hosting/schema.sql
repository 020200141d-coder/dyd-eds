-- Estructura de la base de datos - VERSION PARA HOSTING
--
-- Se importa desde phpMyAdmin habiendo seleccionado antes tu base
-- (if0_XXXXXXXX_dyd) en el panel izquierdo. Este archivo NO crea la base:
-- en un hosting compartido la crea el panel del servicio.
--
-- Orden: 1) este archivo   2) datos.sql
--
SET NAMES utf8mb4;

-- Por si una importacion anterior quedo a medias: se borran las tablas
-- (no la base, que en un hosting no se puede) y se crean de nuevo.
